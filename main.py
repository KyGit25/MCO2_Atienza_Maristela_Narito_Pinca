...
class FamilyRelationshipChatbot:
    ...
    def _extract_names_from_statement(self, statement, relationship_phrase):
        ...
        first_name = parts[0].strip().lower().capitalize()
        second_name = parts[1].strip().lower().capitalize()
    ...
    def _process_siblings_statement(self, statement):
        ...
        if len(parts) == 2:
            ...
            if self._would_create_circular_relationship(person1, person2):
                print("That's impossible!")
                return
    ...
    def _process_parents_statement(self, statement):
        ...
        if len(parts) == 3:
            parent1 = parts[0].strip().lower().capitalize()
            parent2 = parts[1].strip().lower().capitalize()
            child = parts[2].strip().lower().capitalize()
    ...
    def _process_brother_statement(self, statement):
        ...
        if (brother.lower() == sibling.lower() or
            ...
            self._would_create_circular_relationship(brother, sibling)):
            print("That's impossible!")
            return
    ...
    def _process_sister_statement(self, statement):
        ...
        if (sister.lower() == sibling.lower() or
            ...
            self._would_create_circular_relationship(sister, sibling)):
            print("That's impossible!")
            return
    ...
    def _process_child_statement(self, statement):
        ...
        if (child.lower() == parent.lower() or
            self._would_create_circular_relationship(child, parent)):
            print("That's impossible!")
            return
    ...
    def _process_daughter_statement(self, statement):
        ...
        if (daughter.lower() == parent.lower() or
            ...
            self._would_create_circular_relationship(daughter, parent)):
            print("That's impossible!")
            return
    ...
    def _process_son_statement(self, statement):
        ...
        if (son.lower() == parent.lower() or
            ...
            self._would_create_circular_relationship(son, parent)):
            print("That's impossible!")
            return
    ...
    def _process_who_daughters_question(self, question):
        ...
        if results:
            daughters = [result['X'].capitalize() for result in results]
    ...
    def _process_who_sons_question(self, question):
        ...
        if results:
            sons = [result['X'].capitalize() for result in results]
...
if __name__ == "__main__":
    chatbot = FamilyRelationshipChatbot("kb.pl")
